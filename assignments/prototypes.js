...
//   this.takeDathismage = attributes.takeDamage;
// }
...
function CharacterStats(characterStatsAttributes) {
  GameObject.call(this, characterStatsAttributes); //binds to parent & add child attr
  this.healthPoints = characterStatsAttributes.healthPoints;
  //this.name = childAttributes.name; don't need this b/c this is on parent//
}    

//told child about parent
CharacterStats.prototype = Object.create(GameObject.prototype);

CharacterStats.prototype.takeDamage = function() {
  return `${this.name} took damage.`; //Don't need ()//
};


  function Humanoid(humanoidAttributes) {
    CharacterStats.call(this, humanoidAttributes);//binds to character & add gchild 
